...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        std::cout << "Time to process a range of " << deq_data.size() << " elements with "
                  << "std::deque<IdxValue> : " << deq_time << " us" << std::endl;
        std::cout << "Time to process a range of " << list_data.size() << " elements with "
                  << "std::list<IdxValue> : " << list_time << " us" << std::endl;
